# Compile Quartus-generated FP IP used by GemvService64:
#   fp16ToFp32, fp32ToFp16  (VHDL altera_fp_functions)
#   fp32MultAcc, fp32Add    (Verilog Agilex native FP DSP)
# fp32Rsqrt is NOT used by GEMV (no rsqrt in the MAC datapath).
...
# Shared VHDL packages (identical across fp16/fp32 function IPs)
...
# IP shells (instantiated by Spinal adapters in the generated RTL)
