...
// SystemVerilog created from fp32ToFp16_altera_fp_functions_19110_qtmnoha
// SystemVerilog created on Mon Jun  1 12:13:15 2026


(* altera_attribute = "-name AUTO_SHIFT_REGISTER_RECOGNITION OFF; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 10037; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 113007; -name MESSAGE_DISABLE 10958" *)
module fp32ToFp16_altera_fp_functions_19110_qtmnoha (
    input wire [31:0] a,
    input wire [0:0] en,
    output wire [15:0] q,
    input wire clk,
    ...
    begin
        if (areset)
        begin
            expFracR_uid29_fpToFPTest_o <= 22'b0;
        end
        else if (en == 1'b1)
        begin
    ...
    fracXIsZero_uid14_fpToFPTest_delay ( .xin(fracXIsZero_uid14_fpToFPTest_qi), .xout(fracXIsZero_uid14_fpToFPTest_q), .ena(en[0]), .clk(clk), .aclr(areset) );
    ...
    dspba_delay_ver #( .width(1), .depth(1), .reset_kind("SYNC"), .phase(0), .modulus(1) )
    expXIsMax_uid13_fpToFPTest_delay ( .xin(expXIsMax_uid13_fpToFPTest_qi), .xout(expXIsMax_uid13_fpToFPTest_q), .ena(en[0]), .clk(clk), .aclr(areset) );
    ...
    dspba_delay_ver #( .width(1), .depth(1), .reset_kind("SYNC"), .phase(0), .modulus(1) )
    excN_x_uid17_fpToFPTest_delay ( .xin(excN_x_uid17_fpToFPTest_qi), .xout(excN_x_uid17_fpToFPTest_q), .ena(en[0]), .clk(clk), .aclr(areset) );
    ...
    dspba_delay_ver #( .width(1), .depth(1), .reset_kind("SYNC"), .phase(0), .modulus(1) )
    excZ_x_uid12_fpToFPTest_delay ( .xin(excZ_x_uid12_fpToFPTest_qi), .xout(excZ_x_uid12_fpToFPTest_q), .ena(en[0]), .clk(clk), .aclr(areset) );
    ...
    dspba_delay_ver #( .width(1), .depth(1), .reset_kind("SYNC"), .phase(0), .modulus(1) )
    excRInf_uid39_fpToFPTest_delay ( .xin(excRInf_uid39_fpToFPTest_qi), .xout(excRInf_uid39_fpToFPTest_q), .ena(en[0]), .clk(clk), .aclr(areset) );
    ...
    dspba_delay_ver #( .width(1), .depth(1), .reset_kind("SYNC"), .phase(0), .modulus(1) )
    excRZero_uid37_fpToFPTest_delay ( .xin(excRZero_uid37_fpToFPTest_qi), .xout(excRZero_uid37_fpToFPTest_q), .ena(en[0]), .clk(clk), .aclr(areset) );
